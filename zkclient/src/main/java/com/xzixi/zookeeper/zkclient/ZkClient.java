...
public class ZkClient {
    ...
    public ZkClient(CuratorFrameworkFactory.Builder builder) {
        if (builder==null) {
            throw new ZkException("builder不能为null");
        }
        client = builder.build();
    }

    public ZkClient(CuratorFrameworkFactory.Builder builder, String charset) {
        if (builder==null) {
            throw new ZkException("builder不能为null");
        }
        client = builder.build();
    ...
    public void deleteNode(final String path) {
        try {
            ...
            throw new ZkException("删除节点失败", e);
        }
    }
    ...
    public void setNodeData(String path, String data) {
        try {
            ...
            throw new ZkException("设置节点数据失败", ex);
        }
    }
    ...
    public String getNodeData(String path) {
        try {
            ...
            throw new ZkException("获取指定节点的数据失败", e);
        }
    }
    ...
    public List<String> getChildren(String path) {
        ...
        try {
            ...
            throw new ZkException("获取子节点出错", e);
        }
        return childrenList;
    }
    ...
    public TreeCache watch(String path, TreeCacheListener listener, Executor pool) {
        ...
        try {
            ...
            throw new ZkException("监听节点出错", e);
        }
        return cache;
    }
    ...
    public void unwatch(TreeCache cache, TreeCacheListener listener) {
        if (cache==null) {
            throw new ZkException("TreeCache实例不能为null");
        }
